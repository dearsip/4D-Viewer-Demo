...
//    public static List<Platform> createPlatforms(Track track, int ymin, int ymax) //throws Exception
//    {
...
//    public static void createPlatforms(Track track, int y, List<Platform> platforms) //throws Exception
//    {

//        List<Tile> tiles = track.findAllTiles(y);
...
//    public static void createNormalPlatforms(Track track, List<Tile> tiles, List<Tile> platforms, int y) //throws Exception
//    {
...
//    public static void scan(List<Tile> tiles, int[] min, int[] max)
//    {
//        bool first = true;
//        Iterator i = tiles.iterator();
//        while (i.hasNext())
...
//    public static void createThinPlatforms(Track track, List<Tile> tiles, List<Tile> platforms) //throws Exception
//    {
//        Iterator i = tiles.iterator();
//        while (i.hasNext())
//        {
...
//        List<Tile> tiles = track.findAllTiles(min, max);
...
//    public static Geom.Shape getRoundOutline(Track track, int[] min, int[] max, List<Tile> tiles, int rounding, bool more) //throws Exception
//    {
...
//    }
//    public static Geom.Shape getRoundOutline(int dim, int[] min, int[] max, int rounding, Arc arc, bool corner) //throws Exception
//    {
...
//    public static bool isBitSet2(int n, int dir1, int dir2)
//    {
...
//    public static bool canRound(int[] min, int[] max, List<Tile> tiles, bool more, int dir1, int dir2)
//    {
...
//    public static bool getLoopVertices(int[] min, int[] max, int dir3, int axis, int rounding,
...
//    public static int classify(bool flat, int dir, int dir3, int rounding)
//    {
...
//    public static int getEdgeAdjustment(int[] min, int[] max, bool flat1, bool flat2, int dir1, int dir2, int dir3, int rounding, Arc arc, double[] adj, bool corner, double dx1) //throws Exception
//    {
...
//    public static Geom.Shape getThinOutline(Track track, int[] min, int[] max, List<Tile> tiles, bool round) //throws Exception
//    {
...
//    public static bool[] getConnections(int dim, List<Tile> segs)
//    {
...
//    public static Geom.Shape thinJunction2(int[] pos, int nDir, bool[] conn, double w2)
//    {
...
//    public static Geom.Shape thinJunction3(int[] pos, int nDir, int nStr, bool[] conn, double w2, double m)
//    {
...
//    public static void buildBigFace(int db, bool[] conn, int[][][] vindex, Geom.Builder builder)
//    {
...
//        List<Tile> shapes = new List<Tile>();
//        List<Tile> textures = new List<Tile>();
//        if (bot[1] == 0)
//        {
